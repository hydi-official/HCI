...
const HeaderBottom = () => {
  ...
  return (
    <div className="w-full bg-[#CCC8C9] relative">
          ...
          >
            ...
            {show && (
              ...
              >
                ...
                <Link to='/Wigs'><li className="text-gray-400 px-4 py-1 border-b-[1px] border-b-gray-400  hover:border-b-white hover:text-white duration-300 cursor-pointer">
                  Wigs
                </li>
                </Link>
